...
import { SearchObjects } from "./modules/buckets/searchObjects";
import { SyncIndex } from "./modules/buckets/syncIndex";
...
export function R2Explorer(config?: R2ExplorerConfig) {
	...
	openapi.get("/api/buckets/:bucket/search", SearchObjects);
	openapi.post("/api/buckets/:bucket/sync-index", SyncIndex);
